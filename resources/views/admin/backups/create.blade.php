@extends('layouts.admin') {{-- Replace with your actual layout file name --}}
            ...
            <div class="bg-white rounded-2xl border border-slate-200/80 p-5 shadow-sm space-y-4">
                ...
                <div class="space-y-3">
                    <div class="flex justify-between text-xs">
                        <span class="text-slate-500">Disk Partition</span>
                        <span class="font-mono font-bold text-slate-700">/dev/sda1</span>
                    </div>
