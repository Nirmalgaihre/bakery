...
<div class="container mx-auto py-6 px-4 max-w-3xl font-sans antialiased text-slate-600">
    ...
    <div class="mb-6">
        ...
        <p class="text-xs text-slate-400 mt-0.5">Create a secure system portal access profile for management or
            administrative teams.</p>
    </div>
    ...
    <div class="bg-white border border-slate-200/60 rounded-lg shadow-sm overflow-hidden p-6">
        <form method="POST" action="{{ route('admin.staff.store') }}" class="space-y-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    <label for="password"
                        class="block text-xs font-semibold text-slate-700 mb-1.5 uppercase tracking-wider">Account
                ...
                <div>
                    <label for="password_confirmation"
                        class="block text-xs font-semibold text-slate-700 mb-1.5 uppercase tracking-wider">Confirm
                        Password <span class="text-rose-500">*</span></label>
                    <div class="relative">
                        <span
                            class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none text-slate-400">
