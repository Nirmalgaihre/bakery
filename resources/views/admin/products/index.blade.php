...
<div class="max-w-7xl w-full mx-auto">
    ...
    <tr class="bg-slate-100/70 border-b border-slate-200 text-xs font-bold uppercase tracking-wider text-slate-500">
        ...
        <th class="p-4">Item Code</th> <th class="p-4">Specs (Color/Size)</th> <th class="p-4">Category</th>
        <th class="p-4 text-right">Purchase</th>
        <th class="p-4 text-right">Selling</th>
        <th class="p-4 text-center">Unit</th>
        <th class="p-4 text-center bg-slate-50 border-x border-slate-200/60">Initial</th>
        <th class="p-4 text-center bg-blue-50/40 text-blue-900 font-bold">Current</th>
...
<tbody class="divide-y divide-slate-100">
    ...
    <tr class="hover:bg-slate-50/80 transition-colors">
        ...
        <td class="p-4 text-center font-bold font-mono text-blue-700 bg-blue-50/20">{{ $totalAvailable }}</td>
        <td class="p-4 text-center">
        ...
        <td class="p-4 text-right px-5">
            <a href="{{ route('admin.inventory.create', $product->id) }}" class="inline-flex items-center gap-1 bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-[11px] px-2.5 py-1 rounded uppercase shadow-xs">Add</a>
        </td>
    </tr>
    @empty
    <tr>
        <td colspan="12" class="p-8 text-center text-sm text-slate-400">No records found.</td>
    </tr>
    @endforelse
</tbody>
            </table>
